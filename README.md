...
- A `README.md` file with explanations of:
  ...
  - Your process/approach.
      I used codepen a lot to test out functionality before implementing them into my code.
      I also found it helpful to unlink my style.css to figure out what materialize was doing.
  - Unsolved problems.
      Materialize's lightbox breaks carousel and their dropdown links don't actually work.
  - Your biggest wins and challenges.
      I allocated a lot of time to research and when I saw that materialize had functionality to handle a requirement, I incorrectly assumed it would be straight forward.
      I didn't allocate enough time to fixing things that materialize broke. In the future, I might just build from scratch for better control.
